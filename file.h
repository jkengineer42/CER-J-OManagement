...
#include <stdio.h> 
#include <stdlib.h> //fonctions de gestion de la mémoire dynamique
#include <string.h>
#include <stdbool.h> //utilisation des type booléen
#include <errno.h> //gestion des erreurs
#include <dirent.h> //opérations sur les répertoires
#include <math.h> //fonctions mathématiques de base
